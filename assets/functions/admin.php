...
class new_general_setting {
    ...
    function register_fields() {
        ...
        add_settings_field('CopyRight_text', '<label for="CopyRight_text">'.__('CopyRight text' , 'jointswp' ).'</label>' , array(&$this, 'fields_html') , 'general' );
    }
    function fields_html() {
        $value = get_option( 'CopyRight_text', '' );
        echo '<textarea type="text" rows="5" cols="100" id="CopyRight_text" name="CopyRight_text" >' . $value . '</textarea>';
    }
}
